...
if __name__ == '__main__':
    ...
    pyb_env_gui = CorsicaDZ(init_pos+(0,0,0), True, False, dz_level=0)
    pyb_env = CorsicaDZ(init_pos+(0,0,0), False, False, dz_level=0)
    ...
    problem = HolonomicRescueStressPOMDP(init_state, init_belief, pyb_env_gui, pyb_env_gui,
                               max_macro_action_length=3,
                               prm_nodes=500,
                               prm_lower_bounds=(-110, -110, 0),
                               prm_upper_bounds=(110, 110, 100))

    animate(problem, init_state, plot_prm=False, env_evolution_steps=[])
