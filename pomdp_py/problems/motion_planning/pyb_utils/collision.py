...
from pomdp_py.problems.motion_planning.pyb_utils.named_tuples import getJointInfo, getClosestPoints, getContactPoints
...
class CollisionDetector:
    ...
    def compute_distances(self, max_distance=2.0):
    ...
    def in_collision(self, margin=0):
        ...
        for a, b in self.indexed_collision_pairs:
            contact_points = getClosestPoints(
                        a.body_uid,
                        b.body_uid,
                        distance=0,
                        linkIndexA=a.link_uid,
    ...
    # def in_collision(self, margin=0, max_distance=0):
    ...
    #     """
    #
    #     # ds = self.compute_distances(max_distance=margin)
    #     #
    #     # if (ds < margin).any():
    #     #     print("Collision.")
    #     #
    ...
    #         )
    #
    #         if closest_points != [] and closest_points[0].contactDistance < margin:
    #             return True
    #
    #     return False