...
class CorsicaDZ(PyBulletEnv):
    ...
    def load_terrain_collision_objects(self):
        ...
        boxes = [
            [[30, 15, 50], [35, 15, 40], [0, 0, -.2]],
            [[30, 15, 50], [30, -25, 40], [0, 0, -.1]],
        ]
...
def main():
    ...
    env_gui = CorsicaDZ(gui=True, debugger=True, dz_level=0)
