...
class Terrain(PyBulletEnv):
    ...
    def load_goals(self, visualize=True):
        ...
        return self.load_primitive_objects(spheres=spheres, boxes=boxes, rgba=[0, 1, 1, 1])
    ...
    def set_config(self, config):
        ...
        if self._track_robot:
            pyb.resetDebugVisualizerCamera(cameraDistance=30,
                                           cameraYaw=-90,
                                           cameraPitch=-45,
...
def main():
    ...
    env_gui = Terrain(gui=True, debugger=True)
