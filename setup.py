...
extensions = build_extensions(
    ...
    [
        ...
        "problems.motion_planning.environments",
        "problems.motion_planning.nav_2d_continuous",
        "problems.motion_planning.nav_3d_continuous",
        "problems.motion_planning.holonomic_rescue",
        "problems.motion_planning.holonomic_rescue_stress"
    ],
)
